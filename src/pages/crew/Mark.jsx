...
function Mark() {
    ...
    return(
        <section className="relative p-6 sm:px-10 sm:pt-2 sm:pb-0  md:px-24 overflow-hidden">
            ...
            <section className='text-center sm:px-16 md:text-left flex flex-col justify-center md:flex-row md:justify-between  md:items-center '>
                <article id="Explanation" className=" md:w-1/2 sm:mt-12">
                    <div className="">
                        ...
                        <h4 className="text-white text-preset-10  sm:text-[40px] md:text-preset-5 md:w-[50%] mb-3">{da.name.toUpperCase()}</h4>
